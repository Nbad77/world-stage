...
def _build_event_user_prompt(gs, count: int) -> str:
    ...
    return (
        ...
        '  "applicable_npcs": ["list of NPC keys with a genuine stake in this event. '
        'Use ONLY these exact keys: usa, arabia, eu, dprg, russia, china. '
        'Can be empty. A domestic labor dispute does not automatically '
        'involve all six NPCs. Use judgment."],\n'
        '  "choices": [\n'
        '    {\n'
        '      "label": "A",\n'
